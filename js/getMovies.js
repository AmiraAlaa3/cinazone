...
async function displayMovies() {
   ...
   for (let i = 0; i < movieContainer.length; i++) {
      let genre = await getDetails(movieContainer[i].id);
      container += `
           <div class="movie-card">
                    <div class="movie-image">
                        <img src="${imgPath + movieContainer[i].poster_path}" alt="Movie Poster 1">
                        <div>
                            <a class="add-to-watched-list" onclick="addWatched(${movieContainer[i].id});">
                                <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 40 40"
                                    fill="white" class="custom-svg">
                                    <path
                            ...
                            <a class="remove-from-watched-list" onclick="removeWatched(${movieContainer[i].id});">
                                <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 40 40"
                                    fill="white">
                                    <path
                                        d="M35 20C35 11.7188 28.2812 5 20 5C11.7188 5 5 11.7188 5 20C5 28.2812 11.7188 35 20 35C28.2812 35 35 28.2812 35 20Z"
                    ...
                    <div class="movie-info">
                        <h2 class="movie-title">${movieContainer[i].title}</h2>
                        <div class="movie-rate-type">
                            <div class="rate">
                                ...
                                <span>${movieContainer[i].vote_average}</span>
                            </div>
                        ...
                        <div class="movie-time-year">
                            ...
                            <p class="movie-release-year">${movieContainer[i].release_date}</p>
                        </div>
                    </div>
                </div>`;
   }
